...
pub struct SyntaxToken<'a> {
    pub(crate) data: Rc<TokenData<'a>>,
}

impl<'a> SyntaxToken<'a> {
    #[inline]
    pub(crate) fn new(index: u32, green: &'a GreenToken, offset: TextSize, parent: Rc<NodeData<'a>>) -> Self {
        SyntaxToken {
    ...
    pub fn amber(&self) -> AmberToken<'a> {
        self.into()
    }
    ...
    pub fn parent_ancestors(&self) -> impl Iterator<Item = SyntaxNode<'a>> {
