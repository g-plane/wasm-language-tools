...
use lsp_types::{
    Range, SymbolKind as LspSymbolKind, TypeHierarchyItem, TypeHierarchyPrepareParams,
...
impl LanguageService {
    ...
    pub fn type_hierarchy_supertypes(
        ...
        let type_def = symbol_table.symbols.iter().find(|symbol| {
            symbol.kind == SymbolKind::Func && symbol.key.text_range() == type_def_range
        })?;
